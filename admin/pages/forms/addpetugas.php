  ...
  <div class="navbar-menu-wrapper d-flex align-items-top">
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        <h1 class="welcome-text">Input <span class="text-black fw-bold">Petugas</span></h1>
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" name="usn" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Password</label>
                      <input type="password" name="pw" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
              ...
              if(isset($_POST['submit'])){
                  ...
                  location.href='../../../admin/pages/samples/login.html';</script>";
                  } else {
