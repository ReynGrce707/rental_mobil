        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Masukkan Data Mobil</h4>
                  
                  <form class="forms-sample" method="post">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Nomer Polisi</label>
                      <input type="text" name="nopol" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Brand</label>
                      <input type="text" name="brand" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Type</label>
                      <input type="text" name="type" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Tahun Terbit</label>
                      <input type="Date" name="tt" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Harga Booking</label>
                      <input type="number" name="hrg" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                      <div class="form-group">
                    
                  </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Foto Mobil</label>
...
if (isset($_POST['submit'])) {
  ...
  if ($stmt->affected_rows > 0) {
      echo "<script>alert('Sukses menambahkan.'); location.href='../../indexadm';</script>";
  } else {
      echo "<script>alert('Gagal menambahkan.'); location.href='reg_masyarakat.php';</script>";
  }
