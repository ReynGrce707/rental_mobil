...
if ($result->num_rows > 0) {
  ...
  <div class="form-group">
    <label for="exampleInputUsername1">Nomor Polisi</label>
    <input type="text" name="nopol" class="form-control" id="exampleInputUsername1" value="<?php echo $row['nopol']; ?>" placeholder="">  
  <div class="form-group">
    <label for="exampleInputUsername1">Brand</label>
    <input type="text" name="brand" class="form-control" id="exampleInputUsername1" value="<?php echo $row['brand']; ?>" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputUsername1">Type Mobil</label>
    <input type="text" name="tipe" class="form-control" id="exampleInputUsername1" value="<?php echo $row['type']; ?>" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputUsername1">Tahun Terbit</label>
    <input type="date" name="tt" class="form-control" id="exampleInputUsername1" value="<?php echo $row['tahun']; ?>" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputUsername1">Harga Booking</label>
    <input type="number" name="hrg" class="form-control" id="exampleInputUsername1" value="<?php echo $row['harga']; ?>" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputConfirmPassword1">Gambar</label>
    <input type="file" name="img" class="form-control" name="img" value="<?php echo $row['foto']; ?>" placeholder="">
  </div>
...
if(isset($_POST['submit'])){
  ...
  include "../../../koneksi.php";
  $sql= "UPDATE tb_mobil SET nopol='$nopol', brand='$brand', type='$tipe', tahun='$tt', harga='$hrg', foto='$img' WHERE nopol ='$nopol'";
