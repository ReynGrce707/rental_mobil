  ...
  <div class="navbar-menu-wrapper d-flex align-items-top">
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        <h1 class="welcome-text"> <span class="text-black fw-bold"> Daftar History peminjaman buku anda</span></h1>
  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        ...
        <li class="nav-item"> <a class="nav-link" href="datapetugas.php">Data Pegawai / petugas</a></li>
          <li class="nav-item"> <a class="nav-link" href="datauser.php">Data User</a></li>
          <li class="nav-item"> <a class="nav-link active" href="history.php">History Peminjaman</a></li>
        </ul>
      </div>
    </li>
    <ul class="nav">
...
<thead>
  <tr>
    ...
    <th>Status</th>
    <a href="generate_laporan.php" target="_blank" class="btn btn-primary btn-rounded btn-icon"><i class="ti-printer"></i> Generate Laporan ke PDF</a>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td><img src='/PerpusOn/img/" . $row['img'] . "' alt='Gambar Buku' style='width:250px;height:300px;border-radius:0;'></td>";
        ...
        if ($row["status"] == "dipinjam") {
          echo "<td><b><span style='color: red;'>Dipinjam</span></b></td>";
      } elseif ($row["status"] == "telah dikembalikan") {
          echo "<td><span style='color: green;'>Dikembalikan</span>";
      } else {
