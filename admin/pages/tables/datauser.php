...
<div class="d-sm-flex justify-content-between align-items-start">
                                                        <h4 class="card-title">Daftar Petugas</h4>
                                                          <a href="../forms/adduser.php"  type="button" class="btn btn-inverse-primary btn-rounded btn-icon"> <i class="ti-plus"></i></a>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
      echo "<td>" . $row["nik"] . "</td>";
        ...
        echo "<td><a href='delete_petugas.php?id=" . $row["nik"] . "' class='btn btn-danger btn-rounded btn-icon'><i class='ti-trash'></i></a></td>";
