...
<div class="d-sm-flex justify-content-between align-items-start">
                                                        <h4 class="card-title">Daftar Petugas</h4>
                                                          <a href="../forms/addpetugas.php"  type="button" class="btn btn-inverse-primary btn-rounded btn-icon"> <i class="ti-plus"></i></a>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
      echo "<td>" . $row["id_user"] . "</td>";
        echo "<td>" . $row["user"] . "</td>";
        echo "<td>" . $row["lvl"] . "</td>";
        echo "<td><a href='delete_petugas.php?id=" . $row["id_user"] . "' class='btn btn-danger'><i class='ti-trash'></i> Hapus Akun</a></td>";
        echo "</tr>";
    }
} else {
