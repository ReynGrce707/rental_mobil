...
<style>
    .book-card {
        width: 200%;                  /* Lebar card sama dengan kontainer */
        max-width: 300px;            /* Lebar maksimal card, misal 300px */
        height: auto;                /* Tinggi card disesuaikan */
        margin-right: 0px;           /* Jarak antar card */
        border-radius: 10px;         /* Ujung card melengkung */
    }

    .book-image {
        width: 100%;                  /* Gambar menyesuaikan lebar card */
        height: 200px;                /* Tinggi gambar tetap, sesuaikan untuk tampilan landscape */
        object-fit: cover;            /* Menjaga proporsi gambar */
        border-top-left-radius: 10px; /* Ujung gambar melengkung sesuai card */
...
<div id="right-sidebar" class="settings-panel">
  ...
  <ul class="nav">
    ...
    <li class="nav-item nav-category">Proses Aplikasi</li>
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="pages/tables/datapetugas.php">Data Pegawai / petugas</a></li>
          <li class="nav-item"> <a class="nav-link" href="pages/tables/datauser.php">Data User</a></li>
          <li class="nav-item"> <a class="nav-link active" href="pages/tables/history.php">History Peminjaman</a></li>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-sm-flex justify-content-between align-items-start">
                                                        <h4 class="card-title">Daftar Mobil</h4>
                                                          <a href="pages/forms/inputmobil.php"  type="button" class="btn btn-inverse-primary btn-rounded btn-icon"> <i class="ti-plus"></i></a>
...
$query = "SELECT * FROM tb_mobil"; // Ganti 'tb_mobil' dengan nama tabel yang sesuai
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="col-md-4 mb-2">
            <div class="card h-100 book-card shadow-sm">
                ...
                <img src="../img/<?php echo $row['foto']; ?>" class="card-img-top book-image" alt="<?php echo $row['brand']; ?>">
                <div class="card-body">
                    <h5 class="card-title"><?php echo $row["brand"]; ?></h5>
                    <h6 class="card-subtitle mb-2 text-muted">Tipe <?php echo $row["type"]; ?></h6>
                    <p class="card-text">
                        <strong>Nomor Polisi:</strong> <?php echo $row["nopol"]; ?><br>
                        <strong>Tahun Rilis:</strong> <?php echo $row["tahun"]; ?><br>
                        <strong>Harga:</strong> <?php echo number_format($row["harga"], 0, ',', '.'); ?><br>
                    </p>
                </div>
                <div class="card-footer text-center">
                    <div class="button-group">
                        <form action="detail_mobil.php" method="get" style="display: inline;">
                            <input type="hidden" name="nopol" value="<?php echo $row['nopol']; ?>">
                            <button type="submit" name="detail" class="btn btn-outline-info btn-fw">
                                <i class="mdi mdi-apps"></i> 
                            </button>
                        </form>
                        <form action="pages/forms/edit_mobil.php" method="get" style="display: inline;">
                            <input type="hidden" name="nopol" value="<?php echo $row['nopol']; ?>">
                            <button type="submit" name="edit" class="btn btn-outline-info btn-fw">
                                <i class="ti-pencil"></i> 
                            </button>
                        </form>
                        <form action="delete_mobil.php" method="post" style="display: inline;">
                            <input type="hidden" name="nopol" value="<?php echo $row['nopol']; ?>">
                            <button type="submit" name="delete" class="btn btn-outline-info btn-fw">
                                <i class="ti-trash"></i> 
                            </button>
                        </form>
                    </div>
    ...
    echo '<p class="text-center">Tidak ada mobil yang tersedia.</p>';
}
?>
                                                    </div>
                                                </div>
