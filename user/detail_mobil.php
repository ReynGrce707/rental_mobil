              ...
              <div class="home-tab">
                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                    ...
                    <?php
                    include "koneksi.php";
                    $nopol = $_GET['nopol']; // or however you're getting the book ID
...
<div class="col-lg-8 d-flex flex-column">
  ...
  <div class="card-body row">
    <div class="col-md-4">
      <img src="../img/<?php echo $row['foto']; ?>" class="card-img-top book-image"  style="width:250px;height:300px;border-radius:0;" alt="<?php echo $row['brand']; ?>">
      <br><br>
      <h4 class="card-title"><?= $brand ?></h4>
      <?php         echo "<td><a href='pages/forms/pinjam_mobil.php?id=" . $row["nopol"] . "' class='btn btn-primary'>Rental Mobil</a></td>";
?>
    </div>
    <div class="col-md-8">
      ...
      <b><p>Brand: </b> <?= $brand ?></p>
      <b><p>type:</b> <?= $type ?></p>
      <b><p>Tahun Mobil:</b> <?= $thn ?></p>
      <b><p>Harga Pinjam:</b> <?= $hrg ?></p>
