...
<div id="right-sidebar" class="settings-panel">
  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="../../../indexuser.php" aria-expanded="false" aria-controls="ui-basic">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="pinjam.php">Info buku yang dipinjam</a></li>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      if ($row["status"] == 'booking') {
        echo "<td><button class='btn btn-secondary' disabled>Menunggu Persetujuan</button></td>";
      } elseif ($row["status"] == 'approve') {
        echo "<td><a href='ambil_mobil.php?id=" . $row["id_transaksi"] . "' class='btn btn-primary'>Ambil Mobil</a></td>";
    } elseif ($row["status"] == 'ambil') {
        echo "<td><a href='../forms/kembali.php?id=" . $row["id_transaksi"] . "' class='btn btn-primary'>Kembalikan Mobil</a></td>";
    } elseif ($row["status"] == 'kembali') {
        echo "<td><span class='text-success'>Mobil Sudah Dikembalikan</span></td>";
    }
