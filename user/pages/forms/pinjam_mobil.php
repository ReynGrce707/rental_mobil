...
<form class="forms-sample" method="post" action="proses_transaksi.php" onsubmit="calculateTotal()">
            ...
            <div class="form-group">
                ...
                <select name="add_ons" class="form-control" id="add_ons" onchange="calculateTotal()">
 ...
 <script>
        function calculateTotal() {
            ...
            document.getElementById("total").value = total.toFixed(2); // Format ke 2 desimal

            var kekurangan = total - downpayment;
            document.getElementById("kekurangan").value = kekurangan >= 0 ? kekurangan.toFixed(2) : 0; // Pastikan tidak negatif
        }
    </script>
  <!-- container-scroller -->
  <!-- plugins:js -->
