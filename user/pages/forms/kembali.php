            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Masukkan Data Perentalan Mobil</h4>
                  <?php
include "../../koneksi.php"; // Pastikan ini adalah jalur yang benar ke file koneksi Anda
      ...
      // Ambil harga mobil dari database berdasarkan nomor polisi
      $sql = "SELECT * FROM tb_transaksi WHERE id_transaksi = '$id'"; // Sesuaikan dengan nama tabel dan kolom Anda
...
<form class="forms-sample" method="post" action="proses_kembali.php">
    <input type="hidden" name="id_transaksi" value="<?php echo $id; ?>"> 

    <div class="form-group">
        <label for="kondisi_mobil">Kondisi Mobil</label>
        <select name="kondisi_mobil" class="form-control" id="kondisi_mobil" required onchange="hitungDenda()">
            <option value="">Pilih Kondisi Mobil</option>
            <option value="baik">Baik</option>
            <option value="sedang">Sedang/Lecet</option>
            <option value="berat">Berat/Rusak</option>
        </select>
    </div>
...
function hitungDenda() {
    var kondisi = document.getElementById("kondisi_mobil").value;
    var denda = 0;
    ...
    document.getElementById("total").value = denda;
}
</script>
