    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="pages/tables/pinjam.php">Info buku yang dipinjam</a></li>
                                    ...
                                    <div class="row flex-grow">
                                        <div class="grid-margin stretch-card">
                                            <div class="card card-rounded">
                                                ...
                                                <h4 class="card-title">Daftar Mobil Yang Tersedia</h4>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
       ...
       <div class="col-md-4 mb-2">
        ...
        <?php
        $counter++;
        if ($counter % 4 == 0) { // if 4 books have been displayed, start a new row
