        ...
        <ul class="d-flex flex-column-reverse todo-list">
          <li>
            <div class="form-check">
              ...
              <i class="input-helper"></i><i class="input-helper"></i><i class="input-helper"></i><i class="input-helper"></i><i class="input-helper"></i><i class="input-helper"></i></label>
            </div>
              ...
              <div class="home-tab">
                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                    ...
                    $bukuID = $_GET['BukuID']; // or however you're getting the book ID

                    $query = "SELECT * FROM buku WHERE BukuID = $bukuID";
                    $result = $koneksi->query($query);
                    $row = $result->fetch_assoc();

                    // Now you can use the $row variable to display the book information
                    $judul = $row["Judul"];
                    $penulis = $row["Penulis"];
                    ...
                    // Fetch the book rating
                    $ratingQuery = "SELECT AVG(Rating) as avgRating FROM ulasanbuku WHERE BukuID = $bukuID";
...
<div class="col-lg-8 d-flex flex-column">
  ...
  <div class="card-body row">
    <div class="col-md-4">
      <img src="../img/<?php echo $row['img']; ?>" class="card-img-top book-image"  style="width:250px;height:300px;border-radius:0;" alt="<?php echo $row['Judul']; ?>">
      <br><br>
    ...
    <div class="col-md-8">
      ...
      <b><p>Deskripsi: </b> <?= $deskripsi ?></p>
      <b><p>Penulis:</b> <?= $penulis ?></p>
      <b><p>Penerbit:</b> <?= $penerbit ?></p>
      <b><p>Tahun Terbit:</b> <?= $tahunTerbit ?></p>
      <b><p>Kategori:</b> <?= $kategori ?></p>
...
<!-- Display the book rating -->
<div class="col-lg-4 d-flex flex-column">
  <div class="row flex-grow">
    <div class="col-12 grid-margin stretch-card">
      <div class="card card-rounded">
        <div class="card-body">
          <h4 class="card-title">Rating Buku</h4>
          <div class="rating">
          <?php
$ratingQuery = "SELECT ub.*, u.Username 
                FROM ulasanbuku ub 
                JOIN user u ON ub.UserID = u.UserID 
                WHERE ub.BukuID = $bukuID";
$ratingResult = $koneksi->query($ratingQuery);
while ($ratingRow = $ratingResult->fetch_assoc()) {
  $rating = $ratingRow["Rating"];
  $ulasan = $ratingRow["Ulasan"];
  $username = $ratingRow["Username"]; // Get the username from the joined table
  ?>
  <div class="rating-item">
    <div class="rating">
      ...
      <p><?= $ulasan ?> | <b><i><?= $username ?></i></b></p> <!-- Display the username and review -->
    </div>
    <hr class="rating-divider"> <!-- Add a horizontal line to separate each rating -->
  </div>
<?php } ?>
          </div>
        </div>
