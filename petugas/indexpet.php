...
$sql = "SELECT BukuID, Judul, Penulis, Penerbit, TahunTerbit, Kategori, img, deskripsi FROM buku";
...
<style>
    .book-card {
    width: 100%;                  /* Lebar card sama dengan kontainer */
...
<div class="main-panel">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-sm-flex justify-content-between align-items-start">
                                                        <h4 class="card-title">Daftar Buku</h4>
                                                          <a href="pages/forms/inputbuku.php"  type="button" class="btn btn-inverse-primary btn-rounded btn-icon"> <i class="ti-plus"></i></a>
    ...
    <div class="card h-100 book-card shadow-sm">
        <!-- Gambar buku dari database -->
        <img src="../img/<?php echo $row['img']; ?>" class="card-img-top book-image" alt="<?php echo $row['Judul']; ?>">
        <div class="card-body">
            <h5 class="card-title"><?php echo $row["Judul"]; ?></h5>
            <h6 class="card-subtitle mb-2 text-muted">by <?php echo $row["Penulis"]; ?></h6>
            <p class="card-text">
    ...
    <form action="desk.php" method="get" style="display: inline;">
        <input type="hidden" name="BukuID" value="<?php echo $row['BukuID']; ?>">
        <button type="submit" name="deskripsi" class="btn btn-outline-info btn-fw">
            <i class="mdi mdi-apps"></i> 
        </button>
    </form>
    <form action="pages/forms/edit.php" method="get" style="display: inline;">
        <input type="hidden" name="BukuID" value="<?php echo $row['BukuID']; ?>">
        <button type="submit" name="edit" class="btn btn-outline-info btn-fw">
            <i class="ti-pencil"></i> 
        </button>
    </form>
    <form action="delete_buku.php"  method="post" style="display: inline;">
        <input type="hidden" name="BukuID" value="<?php echo $row['BukuID']; ?>">
        <button type="submit" name="delete" class="btn btn-outline-info btn-fw">
            <i class="ti-trash"></i> 
                                                            ...
                                                            echo '<p class="text-center">Tidak ada buku yang tersedia.</p>';
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
