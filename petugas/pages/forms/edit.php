  ...
  <div class="navbar-menu-wrapper d-flex align-items-top">
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        <h1 class="welcome-text">Edit <span class="text-black fw-bold">Data Buku</span></h1>
...
if ($result->num_rows > 0) {
  ...
  <div class="form-group">
    ...
    <input type="text" name="jdl" class="form-control" id="exampleInputUsername1" value="<?php echo $row['Judul']; ?>" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputUsername1">Penulis</label>
    <input type="text" name="penulis" class="form-control" id="exampleInputUsername1" value="<?php echo $row['Penulis']; ?>" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputUsername1">Penerbit</label>
    <input type="text" name="penerbit" class="form-control" id="exampleInputUsername1" value="<?php echo $row['Penerbit']; ?>" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputUsername1">Tahun Terbit</label>
    <input type="number" name="tt" class="form-control" id="exampleInputUsername1" value="<?php echo $row['TahunTerbit']; ?>" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputUsername1">Kategori (Genre Buku)</label>
    <input type="text" name="genre" class="form-control" id="exampleInputUsername1" value="<?php echo $row['Kategori']; ?>" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputUsername1">Deskripsi | Sinopsis</label>
    <input type="text" name="desk" class="form-control" id="exampleInputUsername1" value="<?php echo $row['deskripsi']; ?>" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputConfirmPassword1">Cover Buku</label>
    <input type="file" name="img" class="form-control" name="img" value="<?php echo $row['img']; ?>" placeholder="">
  </div>
  <input type="hidden" name="BukuID" value="<?php echo $row['BukuID']; ?>">
  <input name="submit" type="submit" class="btn btn-primary me-2">
...
if(isset($_POST['submit'])){
  ...
  include "../../../koneksi.php";
  $sql= "UPDATE buku SET Judul='$judul', Penulis='$pnls', Penerbit='$pnrbit', TahunTerbit='$tt', Kategori='$ktgr', img='$img', deskripsi='$desk' WHERE BukuID='$BukuID'";
