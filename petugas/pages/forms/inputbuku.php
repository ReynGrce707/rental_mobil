  ...
  <div class="navbar-menu-wrapper d-flex align-items-top">
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        <h1 class="welcome-text">Input <span class="text-black fw-bold">Data Buku</span></h1>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" name="jdl" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Penulis</label>
                      <input type="text" name="penulis" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Penerbit</label>
                      <input type="text" name="penerbit" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Tahun Terbit</label>
                      <input type="number" name="tt" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Kategori (Genre Buku)</label>
                      <input type="text" name="genre" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputUsername1">Deskripsi | Sinopsis</label>
                      <input type="text" name="desk" class="form-control" id="exampleInputUsername1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Cover Buku</label>
                      <input type="file" name="img" class="form-control" name="img" placeholder="halah">
                    </div>
...
if(isset($_POST['submit'])){
  ...
  $stmt = $koneksi->prepare("INSERT INTO buku (Judul, Penulis, Penerbit, TahunTerbit, Kategori, img, deskripsi) VALUES (?, ?, ?, ?, ?, ?, ?)");
  $stmt->bind_param("ssssssi", $judul, $pnls, $pnrbit, $tt, $ktgr, $img, $desk);
  $stmt->execute();

  if($stmt->affected_rows > 0) {
    echo "<script>alert('Sukses menambahkan.');
    location.href='../../indexadm';</script>";
  } else {
